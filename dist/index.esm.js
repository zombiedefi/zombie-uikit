...
var Icon$I = function (props) {
    return (React.createElement(Svg, __assign({ xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24" }, props),
        React.createElement("g", { fill: "none", "fill-rule": "evenodd" },
            React.createElement("g", { fill: "#000" },
                React.createElement("path", { "fill-rule": "nonzero", d: "M6.89 13.403c-.548.067-.938.566-.871 1.114.067.548.566.938 1.114.87.548-.066.938-.565.871-1.113-.067-.548-.566-.938-1.114-.871zM3.548 10.79c-.067-.55.323-1.048.871-1.115.549-.067 1.047.323 1.114.871.067.549-.323 1.047-.87 1.114-.55.067-1.048-.323-1.115-.87zM5.919 5.462c-.548.067-.938.566-.871 1.114.067.548.566.938 1.114.871.548-.067.938-.566.87-1.114-.066-.548-.565-.938-1.113-.871zM13.697 7.281c-.067-.548.323-1.047.872-1.114.548-.067 1.046.323 1.113.871.067.549-.322 1.047-.87 1.114-.549.067-1.048-.323-1.115-.87zM9.993 8.879c-.549.067-.939.565-.872 1.114.067.548.566.938 1.114.87.549-.066.939-.565.872-1.113-.067-.548-.566-.938-1.114-.871zM9.393 5.037c-.067-.548.323-1.047.871-1.114.549-.067 1.047.323 1.114.871.067.548-.323 1.047-.87 1.114-.55.067-1.048-.323-1.115-.871z", transform: "translate(2 2)" }),
                React.createElement("path", { d: "M.253 9.764C.383 4.38 4.853.122 10.236.253c5.383.13 9.642 4.6 9.511 9.983-.008.341-.123.653-.334.91-.202.244-.463.405-.721.513-.502.21-1.131.275-1.754.28-2.689.018-5.024 2.33-5.177 5.058-.035.636-.144 1.283-.418 1.792-.142.263-.34.514-.62.695-.285.186-.613.271-.96.263-5.382-.13-9.64-4.6-9.51-9.983zM10.2 1.752C5.645 1.642 1.863 5.245 1.752 9.8c-.11 4.555 3.493 8.337 8.048 8.448.068.001.093-.013.106-.021.019-.013.063-.05.117-.15.117-.217.21-.601.24-1.164.195-3.475 3.142-6.45 6.665-6.475.562-.003.956-.067 1.186-.163.081-.034.12-.063.134-.076.11-4.555-3.493-8.336-8.048-8.447z", transform: "translate(2 2)" }))))
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }/* , props */),
        React.createElement("image", { width: "205", height: "26", href: /* isDark ? 'images/brain/LogoTextNewDark.png' : */ 'images/brain/LogoTextNewWhite.png' })));
};
...
var Icon$T = function (props) {
    return (React.createElement(Svg, __assign({ xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24" }, props),
        React.createElement("g", { fill: "none", "fill-rule": "evenodd" },
            React.createElement("g", { fill: "#000" },
                React.createElement("path", { d: "M2.94.512c1.558-.177 3.133-.177 4.692 0l1.596.182c.228.026.432.155.553.35.12.197.145.437.066.653L7.645 7.713H10c.246 0 .476.121.617.323.14.203.172.46.085.691l-.19.507c-1.322 3.52-3.19 6.808-5.535 9.745l-.391.49c-.199.248-.533.344-.834.239-.3-.105-.502-.39-.502-.708v-7.152H1.429c-.389 0-.713-.297-.747-.684L.559 9.782C.35 7.444.35 5.092.559 2.755l.123-1.382c.031-.355.308-.639.662-.68l1.595-.18zm4.523 1.49c-1.447-.164-2.908-.164-4.354 0l-.987.113-.069.772c-.2 2.25-.2 4.513 0 6.762l.062.699H4c.414 0 .75.335.75.75v5.704c1.702-2.342 3.101-4.892 4.163-7.589H6.57c-.244 0-.474-.12-.614-.32s-.174-.457-.09-.687l2.244-6.13-.648-.073z", transform: "translate(7 2)" }))))
    // <Svg viewBox="0 0 24 24" {...props}>
